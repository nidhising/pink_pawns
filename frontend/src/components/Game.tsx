...
export default function Game({ socket, roomId, playerColor }: GameProps) {
  ...
  const handleOfferDraw = () => {
      ...
      toast({ title: "Draw Offered", description: "You have offered a draw." });
  };
        ...
        <CardContent className="space-y-4">
            ...
            <div className="flex gap-2 flex-wrap">
                ...
                {drawOfferedByOpponent && (
                    <Button variant="outline" size="sm" onClick={handleAcceptDraw} disabled={gameOver}>Accept Draw</Button>
                )}
            </div>
